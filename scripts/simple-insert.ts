...
async function main() {
  console.log('💾 Inserting AI generation settings...')
  
  try {
    // Insert Rosalina settings
    await sql`
      INSERT INTO costume_ai_generation (
        ...
        quality_modifiers, style_enhancements, model_options
      )
      VALUES (
        'rosalina-ai-gen',
        'rosalina',
        ...
        'low quality, blurry, medieval armor, casual clothing, extra limbs, watermark, sunglasses, frowns, words on clothing',
        30,
        'auto',
        true,
        1,
        ...
        ARRAY['photorealistic', 'sharp focus', '8K', 'studio lighting', 'color accuracy'],
        ARRAY['dramatic', 'cinematic', 'soft lighting', 'hyper-detailed'],
        '{}'
      )
    `
    console.log('✅ Inserted Rosalina settings')
    
    // Insert Bowsette settings
    await sql`
      INSERT INTO costume_ai_generation (
        id, costume_id, model, seed, primary_prompt, negative_prompt, 
        steps, resolution, show_explicit_content, num_outputs, 
      ...
      VALUES (
        ...
        'priority-order',
        7,
        ARRAY['bowsette-blurred', 'bowsette-crown', 'bowsette-horns', 'bowsette-wig'],
        ARRAY['photorealistic', 'sharp focus', '8K', 'studio lighting', 'color accuracy'],
        ARRAY['dramatic', 'cinematic', 'soft lighting', 'hyper-detailed'],
        '{}'
      )
    `
    console.log('✅ Inserted Bowsette settings')
    
    // Insert Daisy Bodysuit settings
    await sql`
      INSERT INTO costume_ai_generation (
        id, costume_id, model, seed, primary_prompt, negative_prompt, 
        steps, resolution, show_explicit_content, num_outputs, 
      ...
      VALUES (
        ...
        'The user uploaded a personal photo (image 1).
          ...
          The image should emphasize craftsmanship, fabric details, and authentic video game character costuming.
          Keep the users hairstyle, facial expression and skin tone.',
        'low quality, blurry, distorted face, extra limbs, wrong costume, casual clothing, watermark',
        30,
        'auto',
        false,
        1,
    ...
    `
    console.log('✅ Inserted Daisy Bodysuit settings')
    
    console.log('\n🎉 All AI generation settings inserted successfully!')
